...
> **📅 עדכון אחרון:** 1 באוגוסט 2025 ### 🔧 רמה 3: מסמכי Root והגדרות (4 מסמכים)

#### 12. 📖 **README.md** - מבוא לפרויקט ומדריך התחלה

#### 13. 🛠️ **DEVELOPMENT.md** - הנחיות פיתוח בסיסיות ופקודות

#### 14. ⚠️ **CRITICAL_PROJECT_CONTEXT_NEW.md** - חוקי ברזל וסטנדרטים

#### 15. 🤖 **COPILOT_GUIDELINES.md** - הנחיות לעבודה עם AI

### 📚 סה"כ: 15 מסמכים עיקרייםוספת אחרונה:\*\* מדריך התחברות אוטומטית
