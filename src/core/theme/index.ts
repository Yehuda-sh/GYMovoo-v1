 ...
 * @description ערכת נושא מרכזית של האפליקציה עם תמיכה מלאה ב-RTL
 * English: Central theme system with full RTL support
 *
 * @features
 ...
 * @updated 2025-09-11 העברה לארכיטקטורה חדשה והסרת helpers לא בשימוש
 */
