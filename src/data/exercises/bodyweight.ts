...
export const bodyweightExercises: Exercise[] = [
  ...
  },
  {
    ...
    instructions: {
      he: [
        "שב על קצה כיסא או ספסל חזק",
        "שים את הידיים לצד הירכיים ותופס את הקצה",
        "הזז את הגוף קדימה והורד באיטיות",
        "דחף חזרה למעלה עד זרועות ישרות",
      ],
      en: [
        "Sit on edge of sturdy chair or bench",
        "Place hands beside hips gripping edge",
        "Move body forward and lower slowly",
        "Push back up until arms are straight",
      ],
    },
    tips: {
      he: ["אל תרד יותר מדי נמוך", "שמור על גוף קרוב לכיסא"],
      en: ["Don't go too low", "Keep body close to chair"],
    },
    safetyNotes: {
      he: ["ודא שהכיסא יציב", "הפסק אם מרגיש כאב בכתפיים"],
      en: ["Ensure chair is stable", "Stop if shoulder pain occurs"],
    },
    media: {
      image: "exercises/tricep_dips.jpg",
      video: "",
      thumbnail: "exercises/tricep_dips_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
  ...
  },
  {
    ...
    tips: {
      he: ["שמור על ירכיים נמוכות", "נשימה קצבית"],
      en: ["Keep hips low", "Rhythmic breathing"],
    },
    safetyNotes: {
      he: ["התחל איטי", "הפסק אם מרגיש חולשה"],
      en: ["Start slow", "Stop if feeling weak"],
    },
    media: {
      image: "exercises/mountain_climbers.jpg",
      video: "",
  ...
  },
  {
    ...
    instructions: {
      he: [
        "עמוד במרחק זרוע מהקיר",
        "שים כפות ידיים על הקיר ברוחב כתפיים",
        "התכופף לעבר הקיר",
        "דחף חזרה לעמדת ההתחלה",
      ],
      en: [
        "Stand arm's length from wall",
        "Place palms on wall shoulder-width apart",
        "Lean toward wall",
        "Push back to starting position",
      ],
    },
    tips: {
      he: ["שמור על גוף ישר", "תנועה איטית ומבוקרת"],
      en: ["Keep body straight", "Slow controlled movement"],
    },
    safetyNotes: {
      he: ["ודא קיר יציב", "התחל קרוב לקיר"],
      en: ["Ensure stable wall", "Start close to wall"],
    },
    media: {
      image: "exercises/wall_pushups.jpg",
      video: "",
      thumbnail: "exercises/wall_pushups_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: false,
    outdoorSuitable: true,
  ...
  },
  {
    ...
    instructions: {
      he: [
        "עמוד זקוף עם רגליים יחד",
        "הרם את העקבים כמה שיותר גבוה",
        "השהה לשנייה",
        "הורד בשליטה",
      ],
      en: [
    ...
    tips: {
      he: ["השתמש בקיר לאיזון", "הרגש את השרירים נמתחים"],
      en: ["Use wall for balance", "Feel muscles stretching"],
    },
    safetyNotes: {
      he: ["התחל על רצפה מישורית", "היזהר מהחלקה"],
      en: ["Start on level floor", "Beware of slipping"],
    },
    media: {
      image: "exercises/calf_raises.jpg",
      video: "",
      thumbnail: "exercises/calf_raises_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
  ...
  },
  {
    ...
    tips: {
      he: ["הדק את הליבה", "אל תקמור את הגב"],
      en: ["Tighten core", "Don't arch back"],
    },
    safetyNotes: {
      he: ["השתמש במזרן", "תנועה איטית"],
      en: ["Use mat", "Slow movement"],
    },
    media: {
      image: "exercises/glute_bridges.jpg",
      video: "",
      thumbnail: "exercises/glute_bridges_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
