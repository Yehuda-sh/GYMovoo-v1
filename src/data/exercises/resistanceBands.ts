...
export const resistanceBandExercises: Exercise[] = [
  ...
  },
  {
    ...
    name: "דדליפט עם גומי התנגדות",
    nameLocalized: {
      he: "דדליפט עם גומי התנגדות",
      en: "Resistance Band Deadlift",
    },
    category: "strength",
    primaryMuscles: ["hamstrings", "glutes"],
    secondaryMuscles: ["back", "core"],
    ...
    instructions: {
      he: [
        "עמוד על גומי ההתנגדות עם רגליים פתוחות רוחב כתפיים",
        "אחוז בקצות הגומי עם כיפוף קל בברכיים",
        "התכופף בירכיים תוך שמירה על גב ישר",
        "חזור לעמידה תוך הדחקת הירכיים קדימה",
      ],
      en: [
        "Stand on resistance band with feet shoulder-width apart",
        "Hold band ends with slight bend in knees",
        "Bend at hips while keeping back straight",
        "Return to standing by driving hips forward",
      ],
    },
    tips: {
      he: ["שמור על החזה למעלה", "הובל עם הירכיים"],
      en: ["Keep chest up", "Lead with hips"],
    },
    safetyNotes: {
      he: ["אל תעגל את הגב", "ודא עמידה יציבה על הגומי"],
      en: ["Don't round back", "Ensure stable stance on band"],
    },
    media: {
      image: "exercises/band_deadlift.jpg",
      video: "",
      thumbnail: "exercises/band_deadlift_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
  ...
  {
    id: "resistance_band_curls",
    name: "קרלס ביצפס עם גומי התנגדות",
    nameLocalized: {
      he: "קרלס ביצפס עם גומי התנגדות",
      en: "Resistance Band Bicep Curls",
    },
    category: "strength",
    primaryMuscles: ["biceps"],
    secondaryMuscles: ["forearms"],
    ...
    instructions: {
      he: [
        "עמוד על גומי ההתנגדות עם רגליים יחד",
        "אחוז בקצות הגומי עם זרועות לצד הגוף",
        "כופף את המרפקים והרם את הידיים לעבר הכתפיים",
        "הורד בשליטה חזרה למצב התחלה",
      ],
      en: [
        "Stand on resistance band with feet together",
        "Hold band ends with arms at sides",
        "Bend elbows and raise hands toward shoulders",
        "Lower with control back to starting position",
      ],
    },
    tips: {
      he: ["שמור על מרפקים קרובים לגוף", "תנועה איטית ומבוקרת"],
      en: ["Keep elbows close to body", "Slow and controlled movement"],
    },
    safetyNotes: {
      he: ["ודא עמידה יציבה", "אל תנדנד את הגוף"],
      en: ["Ensure stable stance", "Don't swing body"],
    },
    media: {
      image: "exercises/band_bicep_curls.jpg",
      video: "",
      thumbnail: "exercises/band_bicep_curls_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
  ...
  {
    id: "resistance_band_lat_pulldown",
    name: "משיכת לאט עם גומי התנגדות",
    nameLocalized: {
      he: "משיכת לאט עם גומי התנגדות",
    ...
    instructions: {
      he: [
        "עגן את הגומי למעלה או אחוז בו עם זרועות מורמות",
        "ישב או עמוד עם חזה ישר",
        "משוך את הגומי כלפי מטה לעבר החזה העליון",
        "שחרר בשליטה חזרה למעלה",
      ],
      en: [
        "Anchor band overhead or hold with arms raised",
        "Sit or stand with chest upright",
        "Pull band down toward upper chest",
        "Release with control back up",
      ],
    },
    tips: {
      he: ["משוך עם הכתפיים", "הרגש את שרירי הגב עובדים"],
      en: ["Pull with shoulder blades", "Feel back muscles working"],
    },
    safetyNotes: {
      he: ["ודא עגינה בטוחה", "אל תשחרר מהר"],
      en: ["Ensure secure anchor", "Don't release quickly"],
    },
    media: {
      image: "exercises/band_lat_pulldown.jpg",
      video: "",
      thumbnail: "exercises/band_lat_pulldown_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
  ...
  },
  {
    ...
    name: "דחיפה עילית עם גומי התנגדות",
    nameLocalized: {
      he: "דחיפה עילית עם גומי התנגדות",
      en: "Resistance Band Overhead Press",
    },
    category: "strength",
    primaryMuscles: ["shoulders"],
    secondaryMuscles: ["triceps", "core"],
    ...
    instructions: {
      he: [
        "עמוד על גומי ההתנגדות עם רגליים פתוחות רוחב כתפיים",
        "אחוז בקצות הגומי בגובה הכתפיים",
        "דחוף את הגומי כלפי מעלה מעל הראש",
        "הורד בשליטה חזרה לגובה הכתפיים",
      ],
      en: [
        "Stand on resistance band with feet shoulder-width apart",
        "Hold band ends at shoulder height",
        "Press band upward overhead",
        "Lower with control back to shoulder height",
      ],
    },
    tips: {
      he: ["שמור על הליבה מהודקת", "אל תנעל את המרפקים למעלה"],
      en: ["Keep core tight", "Don't lock elbows at top"],
    },
    safetyNotes: {
      he: ["ודא עמידה יציבה", "התחל בהתנגדות קלה"],
      en: ["Ensure stable stance", "Start with light resistance"],
    },
    media: {
      image: "exercises/band_overhead_press.jpg",
      video: "",
  ...
  {
    id: "resistance_band_side_steps",
    name: "צעדים לצד עם גומי התנגדות",
    nameLocalized: {
      he: "צעדים לצד עם גומי התנגדות",
      en: "Resistance Band Side Steps",
    },
    category: "strength",
    primaryMuscles: ["glutes"],
    secondaryMuscles: ["quadriceps", "hips"],
    equipment: "resistance_bands",
    difficulty: "beginner",
    instructions: {
      he: [
        "הנח גומי התנגדות סביב הקרסוליים או הברכיים",
        "עמוד עם רגליים מעט פתוחות",
        "צעד לצד תוך שמירה על מתח בגומי",
        "חזור לעמדת ההתחלה וחזור בכיוון השני",
      ],
      en: [
        "Place resistance band around ankles or knees",
        "Stand with feet slightly apart",
        "Step sideways while maintaining band tension",
        "Return to starting position and repeat other direction",
      ],
    },
    tips: {
      he: ["שמור על הברכיים מעט כפופות", "הרגש את הישבן עובד"],
      en: ["Keep knees slightly bent", "Feel glutes working"],
    },
    safetyNotes: {
      he: ["ודא שטח מישורי", "אל תתן לגומי להחליק"],
      en: ["Ensure level surface", "Don't let band slip"],
    },
    media: {
      image: "exercises/band_side_steps.jpg",
      video: "",
      thumbnail: "exercises/band_side_steps_thumb.jpg",
    },
    homeCompatible: true,
    gymPreferred: true,
    outdoorSuitable: true,
