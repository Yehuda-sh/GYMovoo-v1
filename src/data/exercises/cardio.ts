...
export const cardioExercises: Exercise[] = [
  ...
  },
  {
    id: "mountain_climbers_1",
    name: "מטפסי הרים",
    nameLocalized: { he: "מטפסי הרים", en: "Mountain Climbers" },
    category: "cardio",
    primaryMuscles: ["core"],
    ...
    difficulty: "intermediate",
    instructions: {
      he: ["פלאנק גבוה", "הבא ברך לחזה לסירוגין"],
      en: ["High plank", "Drive knees alternating"],
    },
    tips: { he: ["שמור ירכיים נמוך"], en: ["Keep hips low"] },
    safetyNotes: { he: ["שמור פרקי כף יד"], en: ["Protect wrists"] },
    media: {
      image: "exercises/mountain_climbers.jpg",
      video: "",
      thumbnail: "exercises/mountain_climbers_thumb.jpg",
