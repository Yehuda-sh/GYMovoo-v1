/**
 * @file src/features/workout/services/workoutAnalyticsService.ts
 * @description שירות לניתוח נתוני אימון ותובנות מותאמות אישית
 * @status ACTIVE - Moved from src/services/workout/ to features-based architecture
 * @updated 2025-01-08 - Removed unused personalData parameters, fixed type errors, moved to features structure
 */
