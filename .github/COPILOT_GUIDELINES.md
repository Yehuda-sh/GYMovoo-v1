...
Last updated: 2025-09-04 (עדכון הוראות תגובה בעברית)
...
### 🎯 **הוראה קריטית: תגובה בעברית בלבד**
**חובה מוחלטת:** כל התגובות, ההסברים והתקשורת עם המשתמש חייבים להיות בעברית בלבד.
- קוד, פקודות טרמינל, שמות קבצים ונתונים טכניים יכולים להיות באנגלית
- כל הסבר, תיאור או תקשורת עם המשתמש - עברית בלבד
- אין תערובת שפות או מעבר לאנגלית בהסברים
